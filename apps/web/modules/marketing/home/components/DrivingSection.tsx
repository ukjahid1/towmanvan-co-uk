import DrivingForm from "@marketing/driving/DrivingForm";
import React from "react";

export const DrivingSection = () => {
	return (
		<section id="driving-lessons" className="my-16 w-full scroll-my-24">
					...
					<div className="flex flex-col items-start justify-start gap-4 my-12 max-w-2xl">
						...
						<div>
							...
							<p className="text-muted-foreground max-w-2xl">
								...
								project, our driving Learning Service is here to
								help. We connect you with qualified
								professionals who can handle any task with ease.
							</p>
						</div>
					</div>
					<div>
