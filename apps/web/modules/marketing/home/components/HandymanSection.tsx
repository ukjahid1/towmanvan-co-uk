import HandymanForm from "@marketing/handyman/HandymanForm";
import React from "react";

export const HandymanSection = () => {
	return (
		<section id="handyman" className="my-16 w-full scroll-my-20">
					...
					<div className="flex flex-col items-start justify-start gap-4 my-12 max-w-2xl">
						...
						<div>
							...
							<p className="text-muted-foreground max-w-2xl">
								...
								project, our handyman Service is here to help.
								We connect you with qualified professionals who
