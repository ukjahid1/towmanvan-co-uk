		...
		<Popover open={open} onOpenChange={setOpen} modal={modal}>
			<PopoverTrigger asChild>
				{renderTrigger ? (
					...
					<div
						className={cn(
							"flex w-full h-auto cursor-pointer items-center bg-white text-gray-700 placeholder-gray-500 rounded-xl px-4 py-5 shadow-none border-none focus:ring-2 focus:ring-black focus:outline-none",
